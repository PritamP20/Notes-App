...
const Course = () => {
  return ( 
    ...
    <button type="button" class="text-gray-900 text-xl bg-transparent border border-gray-300 focus:outline-none hover:bg-gray-100 hover:from-neutral-50 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg  px-5 py-2.5 me-2 mb-2 light:bg-gray-800 light:text-white light:border-gray-600 light:hover:bg-gray-700 light:hover:border-gray-600 light:focus:ring-gray-700">
